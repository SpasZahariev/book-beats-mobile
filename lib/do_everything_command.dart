...
class DoEverythingCommand {
  ...
  Future<void> makeApiRequests(
      String accessToken, String playlistName, String vibe) async {
...
/*
  ...
  Future<List<String>> searchForTrackIds(
      Map<String, String> openaiSongs, String accessToken) async {
    ...
    for (var entry in openaiSongs.entries) {
      ...
      var searchTracksUrl =
          'https://api.spotify.com/v1/search?q=track:$key artist:$value&type=track,artist&limit=1';
      ...
      var decodedTracks =
          jsonDecode(trackSearchResponse.body)['tracks']['items'];
